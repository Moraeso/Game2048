...
public class GamePage extends JPanel implements Runnable {
	...
	public GamePage() {
		...
		*/
		...
		btnMain.setPressedIcon(new ImageIcon("Image/pressedHome.png"));
		...
		btnSkill2.setPressedIcon(new ImageIcon("Image/clickedSkill2.png"));
		...
		btnSkill3.setPressedIcon(new ImageIcon("Image/clickedSkill3.png"));
		...
		btnRight.setPressedIcon(new ImageIcon("Image/pressedR.png"));
		...
		btnUp.setPressedIcon(new ImageIcon("Image/pressedU.png"));
		...
		btnDown.setPressedIcon(new ImageIcon("Image/pressedD.png"));
		...
		imgBack = new ImageIcon("Image/background70.png");	//배경 이미지
		imgPlayer = new ImageIcon("Image/fighter.png");		//플레이어 이미지
	...
	//PageController에서 listener를 전달받아 팝업창에 add
	...
	//SkillController에서 listener를 전달받아 버튼에 add
	...
	//KeyEvent를 위해 focus가 버튼에 붙지 않도록
	//GamePage의 모든 버튼을 setFocusable(false)로 설정
	...
	private class ButtonListener implements ActionListener {
		public void actionPerformed(ActionEvent event) {
			...
			/* 옵션 버튼들 */
			if (obj == btnReset)		reset.setVisible(true);	// 리셋 버튼 입력 시 리셋 팝업 setVisible(true)
			else if (obj == btnMain)	main.setVisible(true);	// 메인 버튼 입력 시 메인 팝업 setVisible(true)
			
			/* 방향키 입력 */
			else if (obj == btnLeft)	moveLeft(0);
			else if (obj == btnRight)	moveLeft(180);
			else if (obj == btnUp)		moveLeft(90);
			else if (obj == btnDown)	moveLeft(270);
